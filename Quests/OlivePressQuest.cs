...
namespace Taura.Quests.OlivePressQuest
{
    public class GlobalClass
    {
        // Quest-related item's id
        public static string itemId = "olives";
        ...
        public static string workshopStringId = "olive_press";
    ...
    public partial class SubModule
    {
        ...
        public class TaskBehavior : CampaignBehaviorBase
        {
            ...
            public class TaskQuest : QuestBase
            {
                ...
                {
                    public IssueTypeDefiner() : base(001438) // Starting from 001432 (+3 per quest; 001444, 1447 for ex.)
                    {
                    }
