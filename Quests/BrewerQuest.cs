...
namespace Taura.Quests.BrewerQuest
{
    public class GlobalClass
    {
        // Quest-related item's id
        public static string itemId = "grain";
        ...
        public static string workshopStringId = "brewery";
    ...
    public partial class SubModule
    {
        ...
        public class TaskBehavior : CampaignBehaviorBase
        {
            ...
            public class TaskQuest : QuestBase
            {
                ...
                {
                    public IssueTypeDefiner() : base(001432) // Starting from 001432 (+3 per quest; 001444, 1447 for ex.)
                    {
                    }
