...
namespace Taura.Quests.TanneryQuest
{
    public class GlobalClass
    {
        // Quest-related item's id
        public static string itemId = "leather";
        ...
        public static string workshopStringId = "tannery";
    ...
    public partial class SubModule
    {
        ...
        public class TaskBehavior : CampaignBehaviorBase
        {
            ...
            public class TaskQuest : QuestBase
            {
                ...
                {
                    public IssueTypeDefiner() : base(001450) // Starting from 001432 (+3 per quest; 001444, 1447 for ex.)
                    {
                    }
