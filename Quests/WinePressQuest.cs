...
namespace Taura.Quests.WinePressQuest
{
    public class GlobalClass
    {
        // Quest-related item's id
        public static string itemId = "grape";
        ...
        public static string workshopStringId = "wine_press";
    ...
    public partial class SubModule
    {
        ...
        public class TaskBehavior : CampaignBehaviorBase
        {
            ...
            public class TaskQuest : QuestBase
            {
                ...
                {
                    public IssueTypeDefiner() : base(001456) // Starting from 001432 (+3 per quest; 001444, 1447 for ex.)
                    {
                    }
