...
namespace Taura.Quests.LinenWeaveryQuest
{
    public class GlobalClass
    {
        // Quest-related item's id
        public static string itemId = "flax";
        ...
        public static string workshopStringId = "linen_weavery";
    ...
    public partial class SubModule
    {
        ...
        public class TaskBehavior : CampaignBehaviorBase
        {
            ...
            public class TaskQuest : QuestBase
            {
                ...
                {
                    public IssueTypeDefiner() : base(001435) // Starting from 001432 (+3 per quest; 001444, 1447 for ex.)
                    {
                    }
