...
namespace Taura.Quests.WoodWorkshopQuest
{
    public class GlobalClass
    {
        // Quest-related item's id
        public static string itemId = "hardwood";
        ...
        public static int neededItemCount = CalculateNeededItemCount(null); // CalculateNeededItemCount(null);
        
        // Change this if you manually set neededItemCount
        public static bool overrideItemCount = true; // true; 
        ...
        public static string workshopStringId = "wood_WorkshopType";
    ...
    public partial class SubModule
    {
        ...
        public class TaskBehavior : CampaignBehaviorBase
        {
            ...
            public class TaskQuest : QuestBase
            {
                ...
                {
                    public IssueTypeDefiner() : base(001459) // Starting from 001432 (+3 per quest; 001444, 1447 for ex.)
                    {
                    }
